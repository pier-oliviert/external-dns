...
import (
	...
	"github.com/pier-oliviert/external-dns/controller"
	"github.com/pier-oliviert/external-dns/endpoint"
	"github.com/pier-oliviert/external-dns/pkg/apis/externaldns"
	"github.com/pier-oliviert/external-dns/pkg/apis/externaldns/validation"
	"github.com/pier-oliviert/external-dns/plan"
	"github.com/pier-oliviert/external-dns/provider"
	"github.com/pier-oliviert/external-dns/provider/akamai"
	"github.com/pier-oliviert/external-dns/provider/alibabacloud"
	"github.com/pier-oliviert/external-dns/provider/aws"
	"github.com/pier-oliviert/external-dns/provider/awssd"
	"github.com/pier-oliviert/external-dns/provider/azure"
	"github.com/pier-oliviert/external-dns/provider/bluecat"
	"github.com/pier-oliviert/external-dns/provider/civo"
	"github.com/pier-oliviert/external-dns/provider/cloudflare"
	"github.com/pier-oliviert/external-dns/provider/coredns"
	"github.com/pier-oliviert/external-dns/provider/designate"
	"github.com/pier-oliviert/external-dns/provider/digitalocean"
	"github.com/pier-oliviert/external-dns/provider/dnsimple"
	"github.com/pier-oliviert/external-dns/provider/dyn"
	"github.com/pier-oliviert/external-dns/provider/exoscale"
	"github.com/pier-oliviert/external-dns/provider/gandi"
	"github.com/pier-oliviert/external-dns/provider/godaddy"
	"github.com/pier-oliviert/external-dns/provider/google"
	"github.com/pier-oliviert/external-dns/provider/ibmcloud"
	"github.com/pier-oliviert/external-dns/provider/inmemory"
	"github.com/pier-oliviert/external-dns/provider/linode"
	"github.com/pier-oliviert/external-dns/provider/ns1"
	"github.com/pier-oliviert/external-dns/provider/oci"
	"github.com/pier-oliviert/external-dns/provider/ovh"
	"github.com/pier-oliviert/external-dns/provider/pdns"
	"github.com/pier-oliviert/external-dns/provider/pihole"
	"github.com/pier-oliviert/external-dns/provider/plural"
	"github.com/pier-oliviert/external-dns/provider/rcode0"
	"github.com/pier-oliviert/external-dns/provider/rdns"
	"github.com/pier-oliviert/external-dns/provider/rfc2136"
	"github.com/pier-oliviert/external-dns/provider/safedns"
	"github.com/pier-oliviert/external-dns/provider/scaleway"
	"github.com/pier-oliviert/external-dns/provider/tencentcloud"
	"github.com/pier-oliviert/external-dns/provider/transip"
	"github.com/pier-oliviert/external-dns/provider/ultradns"
	"github.com/pier-oliviert/external-dns/provider/vinyldns"
	"github.com/pier-oliviert/external-dns/provider/vultr"
	"github.com/pier-oliviert/external-dns/provider/webhook"
